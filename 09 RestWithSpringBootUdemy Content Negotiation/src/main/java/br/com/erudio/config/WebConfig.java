...
public class WebConfig implements WebMvcConfigurer {
	...
	public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
		/*
		 * Via EXTENSION
		 * Content negotiation - localhost:8090/api/person/v1.xml
		 * 
		...
		/*
		 * Via QUERY PARAM
		 * Content negotiation = localhost:8090/api/person/v1?mediaType=xml
		 * 
		...
		//Via HEADER PARAM
		// Content negotiation (Header da request) = {Key = Accept}, {Value = application/xml}
